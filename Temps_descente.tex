...
\newline
Il apparaït ainsi que la seconde m\'ethode est bien plus efficace que la premi\`ere, cela s'explique par le fait que le changement de variable permet d'\'eviter la singularit\'e en 0.
